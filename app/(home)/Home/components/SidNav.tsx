  ...
  return (
    <div>
      <div className="side-nav">
        ...
        <Link href={'/Home'}>
        <h6 className="cursor-pointer font-semibold home-text">Home</h6>
        </Link>
        <svg
        ...
        <Link href={'/message'}>
        <h5 className="cursor-pointer font-semibold message-text">Messages</h5>
        </Link>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-[40px] h-[25px] post-icon">
        ...
        <h5 className="cursor-pointer font-semibold help-text">Help</h5>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          viewBox="0 0 24 24"
        ...
        <h5 className="cursor-pointer font-semibold more-text">More</h5>
      </div>
    </div>
  );
}

export default SindNav;
