  ...
  return (
    <div>
        ...
        <div className="w-[700px] h-[100vh] float-right">
            ...
            {showDiv && (
            <div className='w-[625px] h-[70px] mt-2 bg-white pl-[5px] pt-[5px] rounded-md shadow-xl'>
              ...
              <p className='text-[12px] ml-[70px] mt-[-50px] font-semibold text-black'>nivin.pauly</p>
            ...
            {showDiv2 && (
            <div className='w-[625px] h-[70px] mt-5 bg-white pl-[5px] pt-[5px] rounded-md shadow-xl'>
