    ...
    <div>
        ...
        <div className="w-[700px] h-[100vh] float-right">
            ...
            <div className='w-[625px] h-[70px] mt-2 bg-white pl-[5px] pt-[5px] rounded-md shadow-md hover:shadow-2xl'>
              ...
              <p className='text-[12px] ml-[70px] mt-[-50px] font-semibold text-black'>nivin.pauly<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="10" viewBox="0 0 48 48" className="ml-[63px] mt-[-13px]">
